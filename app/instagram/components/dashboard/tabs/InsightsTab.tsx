...
export default function InstagramInsightsTab({ result }: { result: InstagramAnalysisResult }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        ...
        <Card>
          <Label style={{ marginBottom: 16 }}>Caption Patterns That Work</Label>
          <BulletList items={insights.captionPatterns} accent="var(--warning)" />
        </Card>
